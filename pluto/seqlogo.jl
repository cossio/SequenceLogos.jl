...
# ╔═╡ e208f78c-f77f-11ef-31e1-992b8f0a001e
import CairoMakie

# ╔═╡ 62df4fc5-5885-40c9-90ec-1461ddbc69d2
import Makie

# ╔═╡ 83c82f2c-2735-43bd-ab01-64946c1491a2
begin # SeqLogo
...
# ╔═╡ 65fbf446-540e-45a2-8fbc-614fa8c9e9e6
begin
	function sort_sequence_logo(logo::SeqLogo)
		weights_sorted, letters_sorted, colors_sorted = sort_sequence_logo(logo.weigths, logo.letters, logo.colors)
	    return SeqLogo(weights_sorted, letters_sorted, colors_sorted)
	end

	function sort_sequence_logo(weights::AbstractMatrix, letters::AbstractMatrix, colors::AbstractMatrix)
...
# ╔═╡ 8e15ce83-37da-424f-a337-4c025f9b2540
begin
	function makie_sequence_logo!(ax::Makie.Axis, weights::AbstractMatrix, letters::AbstractMatrix, colors::AbstractMatrix)
	    @assert size(weights) == size(letters) == size(colors)
	...
	function makie_sequence_logo!(ax::Makie.Axis, weights::AbstractMatrix, letters::AbstractVector, colors::AbstractVector)
	    @assert size(weights, 1) == length(letters) == length(colors)
	    weights_sorted, letters_sorted, colors_sorted = sort_sequence_logo(weights, letters, colors)
	    return makie_sequence_logo!(ax, weights_sorted, letters_sorted, colors_sorted)
	end
end

# ╔═╡ b26e8a21-fee6-4cae-b885-d334e9192736
...
manifest_format = "2.0"
project_hash = "49523d059952a7b6fb6f7dd8190f25909e550779"
